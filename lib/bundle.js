...
class Player{
  ...
  handleTick(event) {
      ...
      if (window.p1Dead != true && window.p1Hit && this.controlType == 1){
        ...
        window.p1Dead = true;
        // debugger
        // window.setTimeout(this.animations.gotoAndStop("falldead"), 2000);
        // window.setTimeout(console.log("interval"),10000);
        // createjs.Ticker.setTimeout(this.animations.gotoAndStop("falldead"),2000);
        // this.animations.gotoAndStop("falldead");
        this.animations.gotoAndPlay("falldead");
        // window.p1Hit = false;
        gameOverMenu();
